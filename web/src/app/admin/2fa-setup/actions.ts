...
/**
 * TOTP enrollment confirmation. The factor was created (unverified) by
 * the page render. Here we challenge + verify the 6-digit code; on
 * success the session upgrades to AAL2 and we redirect to /admin.
 *
 * Both success and failure write an audit_logs row.
 */
